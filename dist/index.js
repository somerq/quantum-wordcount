(function (global, factory) {
	...
	var ThaiWordCount = (function () {
	    function ThaiWordCount() {
	        this.thaiWords = {};
	        this.wordTree = {};
	        this.compoundWords = {};
	...
	var thaiUnicode = [0x0E00, 0x0E7F];
	var thaiContentRatio = 0.2;
	var TWC = new ThaiWordCount();
	function isBreakSpace(str) {
	    return compareCode(str, breakSpace);
	}
	function isFullWidthChar(str) {
	    return compareCode(str, fullWidthChars);
	}
	function compareCode(str, codeArr) {
	...
	function isLangOf(text, langUnicode, ratio) {
	    ...
	    var _a = Array.isArray(langUnicode) ? langUnicode : [langUnicode, langUnicode], min = _a[0], max = _a[1];
	    ...
	    var scoreRatio = score / textLength;
